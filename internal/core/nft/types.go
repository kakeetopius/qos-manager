...
type QosTable struct {
	*nftables.Table
	...
	ForwardOutChain QosChain // rules here match based on destination paramaters
	ForwardInChain  QosChain // rules here match based on source paramaters
...
const (
	...
	FORWARDOUTCHAINNAME = "forward_out"
	FORWARDINCHAINNAME  = "forward_in"
)
